...
interface SettingsDocumentData {
  ...
  navigation: prismic.Repeatable<
    prismic.LinkField<string, string, unknown, prismic.FieldState, 'Link' | 'Button'>
  >
}
...
export interface IntegrationsSliceDefaultPrimary {
   ...
   * - **Documentation**: https://prismic.io/docs/field#group
   */
  integrations: prismic.GroupField<Simplify<IntegrationsSliceDefaultPrimaryIntegrationsItem>>
}
