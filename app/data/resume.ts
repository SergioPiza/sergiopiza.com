...
export const resumeData = {
  ...
  certifications: [
    {
      name: 'Certificate of Special Studies in Data Science (450h) - University of São Paulo',
      date: 'Feb 2023',
    },
    {
      name: 'University Extension Course: VI Advanced School in Big Data Analysis - University of São Paulo',
      date: 'Nov 2022',
    },
    {
      name: 'Data Engineering using Databricks on AWS and Azure - Udemy',
      date: 'Set 2022',
      href: 'https://www.udemy.com/certificate/UC-9197bbfc-7f11-4095-80b4-a04f9bff7546/',
    },
  ],
  technologies: [
    {
      category: 'Programming Languages',
      items: 'Scala, Python, SQL, TypeScript, JavaScript, C, Java, C#',
    },
    {
      category: 'Databases & Storage',
      items: 'AWS Redshift, PostgreSQL, AWS S3, Delta Lake, MongoDB',
    },
    {
      category: 'Data & Orchestration Tools',
      items:
        'Spark, Databricks (Unity Catalog, DLTs, AutoLoader), Airflow, AWS (Glue, API Gateway, CloudFormation, DMS, Lambda)',
    },
